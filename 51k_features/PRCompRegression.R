...
# fit model
fit <- pcr(x50983~., data=df, validation="CV")
...
#  *** caught segfault ***
# address 0x7f7ae3f0be8c, cause 'memory not mapped'
...
# 7: pls::mvr(x50983 ~ ., data = df, validation = "CV", method = "svdpc")
# 8: eval(expr, envir, enclos)
# 9: eval(cl, parent.frame())
#10: pcr(x50983 ~ ., data = df, validation = "CV")
#aborting ...
